...
public class Hbase {
    ...
    static {
        ...
        //设置zookeeper的ip地址
        //通过zk访问hbase
        conf.set("hbase.zookeeper.quorum", "192.168.3.2");
    }
    ...
    public static void getResultScann(String tableName, String start_rowkey,
       ...
       // scan.addColumn((Bytes.toBytes(start_rowkey),"AQMS");
        ResultScanner rs = null;
        HTable table = new HTable(conf, Bytes.toBytes(tableName));
        try {
            rs = table.getScanner(scan);
...
//        addData("rowkey3", "blog2", column1, value1, column2, value2);
       ...
       // getResultScann("blog2", "rowkey4", "rowkey5");
        ...
        //getResultScann("blog2", "rowkey4", "rowkey5");
        // 查询
      //  getResult("or1", "rowkey1");
        // 查询某一列的值
//       getResultByColumn("blog2", "rowkey1", "author", "name");
        // 更新列
//        updateTable("blog2", "rowkey1", "author", "name", "bin");
        // 查询某一列的值
      getResultByColumn("st2", "\\xE6\\xB2\\xAAA57P862015-06-07 15:22:37.0", "f1", "info");
        // 查询某列的多版本
...
//        deleteAllColumn("blog2", "rowkey1");
      ...
      // deleteTable("bigger");
        ...
        //test
        //getResult( "my","B3101054200002014070007");
        //getResultByColumn("oracle2habe", "34EF91940678416BABD42D6AD85EBDCD", "Family1", "AQMS");
        //limit
//        getResultScann("my", "1", "100");
        //limit + 指定列
        //getResultScannWithFamilyAndColumn("my", "1", "100","Family1","sfp");
    }
    public static void getResultScannWithFamilyAndColumn(String tableName, String start_rowkey,
